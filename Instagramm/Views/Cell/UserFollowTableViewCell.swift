...
//  Instagramm
//
//  Created by Николай Гринько on 02.06.2023.
//
...
enum followState {
    case following  // indicates the current user is followingthe other user
    case not_following  // indicates the current user is NOT followingthe other user
}
